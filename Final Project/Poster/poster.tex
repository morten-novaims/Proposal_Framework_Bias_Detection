...
\begin{itemize}
\item Built a dataset with over \textbf{50.000} news articles
\item Scraped over \textbf{19} newspapers for over \textbf{2} weeks
\item With and average of \textbf{1.200} news articles per newspaper
\end{itemize}

\hfill\includegraphics{design_guidelines.png}\hspace*{\fill}
